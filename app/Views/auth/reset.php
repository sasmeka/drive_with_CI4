					...
					<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-success-transparent">
						<div class="row wd-100p mx-auto text-center">
							<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
								<img src="<?php base_url() ?> assets-themes/img/brand/logo-chaakra.png" class="my-auto ht-xl-80p wd-md-100p wd-xl-50p ht-xl-60p mx-auto" alt="logo">
							</div>
						</div>
					</div>
					<!-- The content half -->
								...
								<div class="row">
									<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
										<div class="mb-5 d-flex">
											<a href="index.html"><img src="<?php base_url() ?> assets-themes/img/brand/favicon-chaakra.png" class="sign-favicon-a ht-40" alt="logo">
